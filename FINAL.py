...
SS='C:/Users/Harish Srinivas/Desktop/MRI - alzhemiers/Alzheimer\'s Detection With MRI Brain Scans Using Deep Learning/Samples from hospital/RS2.jpg'
...
if(a == 0):
    print("Mildly Demented") 
    print("   ")
    print ("...")
    imgv = cv2.putText(imgv, 'Mildly Demented', org1, font, 
...
##                       fontScale, color1, thickness, cv2.LINE_AA)
    ...
    print("Moderately Demented")  
    print(" .")
    print (" ")
    imgv = cv2.putText(imgv, 'Moderately Demented', org1, font, 
                       fontScale, color, thickness, cv2.LINE_AA)
...
##                       fontScale, color1, thickness, cv2.LINE_AA)
    ...
    print("Severely Demented") # not applicable
