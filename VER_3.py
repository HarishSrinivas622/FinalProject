...
SS='C:/Users/Harish Srinivas/Desktop/MRI - alzhemiers/image_classification/Datasets/test/MildDemented/8.jpg'
img=image.load_img(SS,target_size=(6304,630))
...
##                       fontScale, color1, thickness, cv2.LINE_AA)
    ...
    print(" .")
    print (" ")
    imgv = cv2.putText(imgv, 'Astrocitoma', org1, font, 
                       fontScale, color, thickness, cv2.LINE_AA)
...
##                       fontScale, color1, thickness, cv2.LINE_AA)
    ...
    print(" .")
    print (" ")
    imgv = cv2.putText(imgv, 'Carcinoma', org1, font, 
                       fontScale, color, thickness, cv2.LINE_AA)
##    imgv = cv2.putText(imgv, ' ,', org2, font, 
##                       fontScale, color1, thickness, cv2.LINE_AA)
##
